...
<tr style="border: 0;">
   <td align="center" valign="top" width="100">
      ...
      <div>
         <a href="/help/tutorials/tutorials.md">
         <strong>Erstellen neuer Inhalte</strong>
         </a>
      </div>
   </td>
   <!-- <td align="center" valign="top" width="100">
...
Im Eingabeaufforderungsbereich können Sie _Parameter_ wie [!DNL Brands], [!DNL Products] und [!DNL Personas] (Richtlinien) und [!DNL Content] (Assets) hinzufügen, um das generierte Erlebnis zu gestalten.
...
Um KI-generierte Inhalte zu erstellen, geben Sie eine [beschreibende Eingabeaufforderung](/help/user-guide/effective-prompts.md) in den Eingabeaufforderungsbereich ein, die den Kontext oder das Erlebnis beschreibt, das Sie generieren möchten, zusammen mit [Richtlinien](/help/user-guide/guidelines/overview.md) und [_Parametern_](#parameters), und klicken Sie auf **[!UICONTROL Generieren]**.
...
* [Erstellen eines Meta-Anzeigen-Erlebnisses](/help/tutorials/create-meta-ad.md)
